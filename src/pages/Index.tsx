      ...
      <div className="container mx-auto p-4 space-y-6">
        ...
        {isLoading ? <p>Loading...</p> : (
          <>
            ...
            <Card><CardHeader><CardTitle>All Time Summary</CardTitle></CardHeader><CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4"><div><p className="text-sm">Total Budget</p><p className="text-2xl font-bold">{currencySymbol}{displayAmount(cumulativeData?.totalBudget || 0)}</p></div><div><p className="text-sm">Total Expenses</p><p className="text-2xl font-bold text-destructive">{currencySymbol}{displayAmount(cumulativeData?.totalExpenses || 0)}</p></div><div><p className="text-sm">Total Income</p><p className="text-2xl font-bold text-green-600">{currencySymbol}{displayAmount(cumulativeData?.totalIncome || 0)}</p></div></CardContent></Card>
            <MotivationalTips />
